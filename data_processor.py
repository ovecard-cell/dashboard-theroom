...
LISBON_PREFIXES = [
    "PANTALON RINGO", "PANTALON SASTRERO RINGO", "JOGGIN RINGO",
    "JEAN SEVEN STRAIGHT", "JEANS SEVEN STRAIGHT",
    "JEAN FALCON REGULAR", "JEANS FALCON REGULAR",
    "CHOMBA TEJIDA", "REMERA OVER LISA LB", "REMERA OVER TRIEND",
]
DISTRICT_PREFIXES = [
    "REMERA GIRONA", "REMERA NAPOLES",
    "JEAN CENTINELA", "JEANS CENTINELA",
